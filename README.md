...
Useful links: ![Create Tables](Database/Queries/CreateTables/CreateCategory.txt), ![Insert Into Tables](Database/Queries/InsertIntoTables/InsertCategories.txt), ![Update Rows](Database/Queries/UpdateRows/UpdateCategories.txt), ![Delete Rows](Database/Queries/DeleteRows/DeleteCategories.txt), ![Select Records](Database/Queries/SelectRecords/SelectCategory.txt). 
### Customer Addresses 
